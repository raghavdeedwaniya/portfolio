          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/raghavdeedwaniya/automated_youtube_channel.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Fully Automated Youtube Channel</h3>
              <p>
              Developed a Python-based automation tool that scrapes trending memes from Reddit, compiles them into engaging videos, and uploads the final content directly to YouTube — streamlining the content creation process end-to-end.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/raghavdeedwaniya/AARRSS_KOC35_CipherSchools.git" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Markting website</h3>
              <p> Developed a fully responsive affiliate marketing website using HTML, CSS, and JavaScript, designed to promote products effectively while ensuring fast performance and an engaging user experience across all devices. </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
              Designed and developed a personal portfolio website using React, TypeScript, and Styled Components to showcase my projects, skills, and experience in a modern, responsive layout.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
